...
from schemas import RecentGameCreate, RecentGamesResponse
...
class RecentGamesService:
    ...
    async def get_recent_games(
        self, user_id: str, cursor: str | None = None, limit: int = 10
    ) -> RecentGamesResponse:
        offset = 0
        position = None
        ...
        return RecentGamesResponse(items=items, next_cursor=next_cursor)
