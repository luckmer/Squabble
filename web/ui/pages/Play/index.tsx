...
const Play: FC<IProps> = ({
  ...
  return (
    <main
      ...
      <section className=' w-full  px-24 h-full flex flex-col'>
        <div className='overflow-y-auto h-full'>
          <div className='min-h-fit grid grid-cols-[minmax(0,1fr)_20rem] gap-12 h-full max-[1000px]:grid-cols-1 max-[1000px]:gap-48 py-40 max-w-6xl mx-auto'>
