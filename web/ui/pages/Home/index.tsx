...
const Home = () => {
  ...
  return (
    <main className='flex flex-col h-full overflow-hidden'>
      <div className='overflow-y-auto min-h-0 w-full pb-10'>
        <section className='bg-[linear-gradient(to_right,oklch(1_0_0/0.035)_1px,transparent_1px),linear-gradient(to_bottom,oklch(1_0_0/0.035)_1px,transparent_1px)] bg-size-[56px_56px] w-full pb-40'>
